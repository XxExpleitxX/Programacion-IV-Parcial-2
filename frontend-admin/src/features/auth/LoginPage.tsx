...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    setError('')
    if (!username || !password) { setError('Por favor completá todos los campos'); return }
    setLoading(true)
    try {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4">
      <h1 className="text-4xl font-bold text-slate-100 mb-10 text-center">Iniciar Sesión</h1>
